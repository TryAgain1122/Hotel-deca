          ...
          <div className='flex flex-col md:flex-row md:items-end justify-between mt-5'>
            <div className='flex mb-3 md:mb-0'>
              <div className='flex gap-3 flex-col items-center justify-center mr-4'>
                ...
                <p className='md:font-bold flex font-medium text-lg xl:text-5xl'> <TbCurrencyPeso />{featuredRoom.price}</p>
              </div>
            </div>
            <Link href={`/rooms${featuredRoom.slug.current}`}
            className='border h-fit text-center border-tertiary-dark px-3 py-2 lg:py-5 lg:px-7 rounded-lg font-bold lg:text-xl hover:bg-tertiary-light'
          >
            More Details
          </Link>
          </div>
